...
let optionalProfileRows = [
    ...
    ProfileRow.create("citation",               Recommended, MANY,  [   (Schema.CreativeWork, OR)
                                                                        (Schema.Text, END)
                                                                    ], 
                                                                    "A citation or reference to another creative work, such as another publication, web page, scholarly article, etc.", 
                                                                    "https://bioschemas.org/profiles/ComputationalWorkflow")
    // Recommended -> Optional
    ProfileRow.create("contributor",            Recommended, MANY,  [   (Schema.Organization, OR)
                                                                        (Schema.Person, END)
                                                                    ], 
    ...
    ProfileRow.create("description",            Recommended, ONE,   [   (Schema.Text, END)], 
                                                                    ...
                                                                    "https://bioschemas.org/profiles/ComputationalWorkflow")
    // Recommended -> Optional
    ProfileRow.create("documentation",          Recommended, MANY,  [   (Schema.CreativeWork, OR)
                                                                        (Schema.URL, END)
                                                                    ], 
                                                                    "Documentation describing the ComputationalWorkflow and its use.", 
                                                                    "https://bioschemas.org/profiles/ComputationalWorkflow")
    // Recommended -> Optional
    ProfileRow.create("funding",                Recommended, MANY,  [   (Schema.Grant, END)], 
                                                                    "The funding for the workflow", 
                                                                    "https://bioschemas.org/profiles/ComputationalWorkflow")
    // Recommended -> Optional
    ProfileRow.create("hasPart",                Recommended, MANY,  [   (Schema.CreativeWork, END)], 
    ...
    ProfileRow.create("keywords",               Recommended, ONE,   [   (Schema.Text, END)], 
                                                                    ...
                                                                    "https://bioschemas.org/profiles/ComputationalWorkflow")
    // Recommended -> Optional
    ProfileRow.create("maintainer",             Recommended, MANY,  [   (Schema.Organization, OR)
                                                                        (Schema.Person, END)
                                                                    ], 
                                                                    ...
                                                                    "https://bioschemas.org/profiles/ComputationalWorkflow")
    // Recommended -> Optional
    ProfileRow.create("producer",               Recommended, MANY,  [   (Schema.Organization, OR)
                                                                        (Schema.Person, END)
                                                                    ], 
    ...
    ProfileRow.create("publisher",              Recommended, MANY,  [   (Schema.Organization, OR)
                                                                    ...
                                                                    "https://bioschemas.org/profiles/ComputationalWorkflow")
    // Recommended -> Optional
    ProfileRow.create("runtimePlatform",        Recommended, MANY,  [   (Schema.Text, END)], 
                                                                    "Runtime platform or script interpreter dependencies (Example - Java v1, Python2.3, .Net Framework 3.0). Supersedes runtime.", 
                                                                    "https://bioschemas.org/profiles/ComputationalWorkflow")
    // Recommended -> Optional
    ProfileRow.create("softwareRequirements",   Recommended, MANY,  [   (Schema.Text, END)], 
                                                                    "Renaming schema.org/requirements as softwareRequirements", 
                                                                    "https://bioschemas.org/profiles/ComputationalWorkflow")
    // Recommended -> Optional
    ProfileRow.create("targetProduct",          Recommended, MANY,  [   (Schema.SoftwareApplication, END)], 
    ...
    ProfileRow.create("image",                  Optional, MANY,     [   (Schema.ImageObject, OR)
                                                                    ...
                                                                    "https://bioschemas.org/profiles/ComputationalWorkflow")
    // properties from OUR LabProtocol profile
    ProfileRow.create("comment",                Recommended, MANY,  [   (Schema.Comment, END)], 
                                                                    "", 
                                                                    "isa-ro-crate-profile/LabProtocol")
    ProfileRow.create("computationalTool",      Recommended, MANY,  [   (Schema.SoftwareApplication, END)], 
