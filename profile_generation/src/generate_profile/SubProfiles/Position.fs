...
let requiredProfileProperties = [
    ...
    ProfileRow.create("name",     Required, ONE,                    [    (Schema.Text, END)
                                                                    ...
                                                                    "MUST be 'Position'", 
                                                                    "**THIS PROFILE**")
    ProfileRow.create("value",              Required, ONE,          [   (Schema.Number, END)],
                                                                    "The position of an input from a [Workflow Protocol profile](#workflow-protocol) described by a [FormalParameter](#formalparameter)", 
                                                                    "**THIS PROFILE**")
]
